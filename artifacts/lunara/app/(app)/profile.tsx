...
export default function ProfileScreen() {
  ...
  const { user, couple, entries, resetOnboarding, notificationSettings, setNotificationSettings } = useApp();
  ...
  const handleReset = () => {
    Alert.alert(
      'Reset Lunara',
      'This will sign you out on this device and restart onboarding. Your backed-up history will be restored when you sign in again.',
      [
           ...
           <View style={styles.premiumGradient}>
            <View style={styles.premiumContent}>
              ...
              <View style={styles.premiumText}>
                <Text style={styles.premiumTitle}>Lunara Premium</Text>
                <Text style={styles.premiumBody}>
                  Unlimited history, photos, voice notes, and full widget customization.
